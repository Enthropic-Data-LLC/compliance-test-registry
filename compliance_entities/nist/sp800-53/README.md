...
| [`maintenance-media-physical-personnel.md`](./maintenance-media-physical-personnel.md) | MA (controlled maintenance records, remote maintenance FIPS+MFA+logging, uncleared personnel escorted), MP (media marking, transport encryption, NIST 800-88, removable media restriction), PE (physical access list review, entry/exit audit, CCTV, visitor log 2yr, fire/HVAC/water protection), PS (position risk designation, screening, termination ≤8h, transfer ≤5d, access agreements, 3rd-party monitoring, sanctions) | ✅ |
| [`risk-acquisition-supply-chain.md`](./risk-acquisition-supply-chain.md) | RA (FIPS 199 categorization, risk assessment triennial + 5 elements, monthly authenticated vuln scans, critical ≤30d SLA), SA (security requirements in contracts, engineering principles, external services inventory, developer SCM and security testing), SR (SCRM plan, critical suppliers, component authenticity, component disposal) | ✅ |
| [`planning-program-training-privacy.md`](./planning-program-training-privacy.md) | PL (SSP 8 sections + annual review, security architecture M/H), PM (CISO designated, risk strategy, valid ATO ≤3yr), AT (annual awareness all personnel + 6 required topics, new employee ≤30d, role-based semi-annual at High, 3yr record retention), PT (legal authority for PII, purpose documented, privacy notice at collection with 5 required elements, sensitive PII heightened protections) | ✅ |
...
## Parse status: Complete — all 20 families parsed across 5 spec files; ~1,007 catalog controls covered; 29 assumptions recorded
